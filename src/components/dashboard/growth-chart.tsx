...
// Courbe de croissance des abonnés (Vue d'ensemble, Analytics). Depuis le
// Lot 4, chaque série prend la couleur officielle de son réseau (la même
// que les pastilles) et les axes/infobulles suivent le thème actif — voir
