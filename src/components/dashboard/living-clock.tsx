...
export function LivingClock({
  ...
  const handTip = polar(currentFraction, RADIUS - 6);
  ...
  return (
    <svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`} className="shrink-0">
      ...
      <line x1={CENTER} y1={CENTER} x2={handTip.x} y2={handTip.y} stroke="rgba(255,255,255,0.55)" strokeWidth={1.5} strokeLinecap="round" />
